...
WebUI.click(findTestObject('Object Repository/OrangeHRM/Admin/Qualification/Page_Delete_Skill/a_Skills'))

WebUI.click(findTestObject('Object Repository/OrangeHRM/Admin/Qualification/Page_Delete_Skill/i_Marketing Skill_oxd-icon bi-trash'))

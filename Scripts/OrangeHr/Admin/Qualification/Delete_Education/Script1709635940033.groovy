...
WebUI.click(findTestObject('Object Repository/OrangeHRM/Admin/Qualification/Page_Delete_Education/a_Education'))

WebUI.click(findTestObject('Object Repository/OrangeHRM/Admin/Qualification/Page_Delete_Education/i_high level_oxd-icon bi-trash'))
